...
def create_sentiment_analysis_dataset(data_args, tokenizer, max_len):
...
def main():
    ...
    train_ds, val_ds, test_ds = create_sentiment_analysis_dataset(data_args, tokenizer, max_seq_len)
